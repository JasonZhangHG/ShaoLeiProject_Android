...
public class HardActivity extends AppCompatActivity {
    ...
    private TextView txt_time,txt_landmine;
    private ImageButton ibn_games;
    private TableLayout tlt_landmine;
    ...
    private int landminenumber=10;//地雷数量
    private int landmineWidth=110;//地雷宽度
    private int leinum=0;//地雷个数计数器
    private int  landmindnumber1=10;//判断游戏是否赢得地雷计数器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Intent intent = new Intent(HardActivity.this,MusicServer.class);
    ...
    private void findViewById() {
        ...
        txt_landmine=(TextView) findViewById(R.id.txt_landmine);
        ibn_games=(ImageButton) findViewById(R.id.ibn_games);
        tlt_landmine=(TableLayout) findViewById(R.id.tlt_landmine);
    }

    private void setListener() {
        ibn_games.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ibn_games.setImageDrawable(getResources().getDrawable(R.drawable.smile));
    ...
    private Runnable runtime=new Runnable() {
        public void run() {
            ...
            if(times<10){
                txt_time.setText("00"+times);
            }else if(times<100){
                txt_time.setText("0"+times);
            }else{
                txt_time.setText(times);
            }
            //设定精确时间
    ...
    private void endGamesLandmine() {
        times=0;
        landmindnumber1=10;
        txt_landmine.setText("010");
        txt_time.setText("000");
        ibn_games.setImageDrawable(this.getResources().getDrawable(R.drawable.smile));
        tlt_landmine.removeAllViews();//删除所有的行
    }
            ...
            for (int j = 0; j < landmineColumns; j++) {
                ...
                landmine[i][j].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(txt_landmine.getText().equals("000")){
                            //最后一步 检测游戏是否结束
                            checkGame();
                        }
                    }
                ...
                landmine[i][j].setOnLongClickListener(new View.OnLongClickListener() {
                    public boolean onLongClick(View v) {
                        ...
                        if(landmindnumber1<10){
                            txt_landmine.setText("00"+landmindnumber1);
                        }else if(landmindnumber1<100){
                            txt_landmine.setText("0"+landmindnumber1);
                        }
    ...
    private void showLandmine() {
        for (int i = 0; i < landmineRows; i++) {
            for (int j = 0; j <landmineColumns; j++) {
                ...
                stopRunTime();//停止计时器
                ibn_games.setImageDrawable(this.getResources().getDrawable(R.drawable.sad));
            }
        }
        landmindnumber1=10;//恢复地雷数量
    }
