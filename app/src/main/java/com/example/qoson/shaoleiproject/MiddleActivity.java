...
public class MiddleActivity extends AppCompatActivity {
    ...
    private TextView txt_time3,txt_landmine3;
    private ImageButton ibn_games3;
    private TableLayout tlt_landmine3;
    ...
    private int landminenumber=8;//地雷数量
    private int landmineWidth=110;//地雷宽度
    private int leinum=0;//地雷个数计数器
    private int  landmindnumber1=8;//判断游戏是否赢得地雷计数器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Intent intent = new Intent(MiddleActivity.this,MusicServer.class);
    ...
    private void findViewById() {
        txt_time3=(TextView) findViewById(R.id.txt_time3);
        txt_landmine3=(TextView) findViewById(R.id.txt_landmine3);
        ibn_games3=(ImageButton) findViewById(R.id.ibn_games3);
        tlt_landmine3=(TableLayout) findViewById(R.id.tlt_landmine3);
    }

    private void setListener() {
        ibn_games3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ibn_games3.setImageDrawable(getResources().getDrawable(R.drawable.smile));
    ...
    private Runnable runtime=new Runnable() {
        public void run() {
            ...
            if(times<10){
                txt_time3.setText("00"+times);
            }else if(times<100){
                txt_time3.setText("0"+times);
            }else{
                txt_time3.setText(times);
            }
            //设定精确时间
    ...
    private void endGamesLandmine() {
        times=0;
        landmindnumber1=8;
        txt_landmine3.setText("008");
        txt_time3.setText("000");
        ibn_games3.setImageDrawable(this.getResources().getDrawable(R.drawable.smile));
        tlt_landmine3.removeAllViews();//删除所有的行
    }
            ...
            for (int j = 0; j < landmineColumns; j++) {
                ...
                landmine[i][j].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(txt_landmine3.getText().equals("000")){
                            //最后一步 检测游戏是否结束
                            checkGame();
                        }
                    }
                ...
                landmine[i][j].setOnLongClickListener(new View.OnLongClickListener() {
                    public boolean onLongClick(View v) {
                        ...
                        if(landmindnumber1<8){
                            txt_landmine3.setText("00"+landmindnumber1);
                        }else if(landmindnumber1<100){
                            txt_landmine3.setText("0"+landmindnumber1);
                        }
    ...
    private void showLandmine() {
        for (int i = 0; i < landmineRows; i++) {
            for (int j = 0; j <landmineColumns; j++) {
                ...
                stopRunTime();//停止计时器
                ibn_games3.setImageDrawable(this.getResources().getDrawable(R.drawable.sad));
            }
        }
        landmindnumber1=8;//恢复地雷数量
    }
